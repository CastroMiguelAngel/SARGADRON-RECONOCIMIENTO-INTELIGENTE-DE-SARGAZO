...
etiqueta_playa = tk.Label(ventana, text="Selecciona la playa")
etiqueta_playa.place(x=840, y=450)
...
# Select de playa
select_playa = ttk.Combobox(cuadro, textvariable=seleccion_playa, values=valores_playa, state="readonly")
select_playa.place(x=840, y=480)  # Ajusta de coordenadas 

# Establecer un valor predeterminado para el select
select_playa.set(valores[0])
